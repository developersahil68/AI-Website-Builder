        ...
        {loading ? (
          ...
          <div className="py-10 min-h-[80vh]">
            <div className="flex items-center justify-between mb-12">
              ...
              <button
                onClick={() => navigate("/")}
                className="flex items-center gap-2 text-white px-3 sm:px-6 py-1 sm:py-2 rounded bg-linear-to-br from-indigo-500 tp-indigo-600 hover:opacity-90 active:scale-95 transition-all"
              >
                ...
                >
                  ...
                  <div className="p-4 text-white bg-linear-180 from-transparent group-hover:from-indigo-950 to-transparent transition-colors">
                    <div className="flex items-start justify-between">
                      ...
                      <button className="px-2 py-0.5 mt-1 ml-2 text-xs bg-gray-800 border boarder-gray-700 rounded-full">
                        Website
                      </button>
                    </div>
