  ...
  return project ? (
    <div className="flex flex-col h-screen w-full bg-gray-900 text-white">
      ...
      <div className="flex max-sm:flex-col sm:items-center gap-4 px-4 py-2 no-scrollbar">
        ...
        {/* right */}
        <div className="flex item-center justify-end gap-3 flex-1 text-xs">
          <button
            onClick={saveProject}
            disabled={isSaving}
            className="max-sm:hidden bg-gray-800 hover:bg-gray-700 text-whjite px-3.5 py-1 flex items-center gap-2 rounded sm:rounded-sm transition-colors border border-gray-700"
          >
            {isSaving ? (
          ...
          <Link
            ...
            className="flx items-center gap-2 px-4 py-1 rounded sm:rounded-sm border border-gray-700 hover:border-gray-500 transition-colors"
          >
